...
A multi-agent customer support system built with the [OpenAI Agents SDK](https://github.com/openai/openai-agents-python), tested with [AgentCI](https://github.com/suniel12/AgentCI).
...
| `test_regression.py` | 19 | Golden baseline comparison via AgentCI DiffEngine |
...
This demo uses AgentCI's `AgentCITraceProcessor` to capture traces from the OpenAI Agents SDK. The trace captures:
