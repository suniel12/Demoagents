"""
Step 1 Tests — Routing correctness for the 2-agent triage system.

Tests verify:
1. Billing queries route to Billing Agent
2. General queries route to General Agent
3. Exactly one handoff per query  
4. Cost stays within budget
"""
...
# ── Golden Queries (Step 1: 2 agents) ─────────────────
